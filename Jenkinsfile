pipeline {
  ...
  environment {
    ...
    IMAGE_NAME = 'ghcr.io/eclipsefdn/scarf-analytics-pipeline/scarf-analytics'
  ...
  post {
    failure {
      mail to: 'ci-admin@eclipse.org',
        subject: "[Scarf Analytics] Build Failure ${currentBuild.fullDisplayName} - ${env.BRANCH_NAME}",
        mimeType: 'text/html',
        body: "Project: ${env.JOB_NAME}<br/>Build Number: ${env.BUILD_NUMBER}<br/>Build URL: ${env.BUILD_URL}<br/>Console: ${env.BUILD_URL}/console"
    }
    fixed {
      mail to: 'ci-admin@eclipse.org',
        subject: "[Scarf Analytics] Back to normal ${currentBuild.fullDisplayName} - ${env.BRANCH_NAME}",
        mimeType: 'text/html',
        body: "Project: ${env.JOB_NAME}<br/>Build Number: ${env.BUILD_NUMBER}<br/>Build URL: ${env.BUILD_URL}<br/>Console: ${env.BUILD_URL}/console"
    }
    cleanup {
